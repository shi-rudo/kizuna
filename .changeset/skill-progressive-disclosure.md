...
- `SKILL.md` now holds the core workflow, the registration and lifetime choices, the rules, and a table that routes each task to a reference. It shrinks from 697 to 140 lines.
